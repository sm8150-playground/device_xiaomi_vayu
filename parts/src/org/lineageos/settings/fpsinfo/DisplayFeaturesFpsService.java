...
public class DisplayFeaturesFpsService extends Service {

    private View mView;
    private Thread mCurFPSThread;
    private final String TAG = "DisplayFeaturesFpsService";
    ...
    public void onCreate() {
        ...
        sharedPrefs.edit().putBoolean(mConfig.PREF_KEY_FPS_STATE, true).commit();
    }
    ...
    private void broadcastServiceState(boolean started) {
        Intent intent = new Intent(mConfig.ACTION_FPS_SERVICE_CHANGED);
        intent.putExtra(mConfig.EXTRA_FPS_STATE, started);
